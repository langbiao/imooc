...
CREATE TABLE `study_category` (
  ...
  `sc_name` varchar(128) NOT NULL COMMENT '分类名称',
  `sc_sort` smallint(2) DEFAULT '0' COMMENT '排序',
  `sc_addtime` datetime DEFAULT NULL COMMENT '添加时间',
  PRIMARY KEY (`sc_id`)
...
-- ----------------------------
INSERT INTO `study_category` VALUES ('1', '计算机技术', '0', '2017-04-14 09:50:49');
INSERT INTO `study_category` VALUES ('2', '电子工程', '1', '2017-04-14 10:27:41');
INSERT INTO `study_category` VALUES ('3', '建筑工程', '2', '2017-04-14 11:04:08');

-- ----------------------------
-- Table structure for study_collect
-- ----------------------------
DROP TABLE IF EXISTS `study_collect`;
CREATE TABLE `study_collect` (
  `sc_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
  `sc_sv_id` int(11) NOT NULL DEFAULT '0' COMMENT '视频sv_id',
  `sc_uid` int(11) NOT NULL DEFAULT '0' COMMENT '用户id',
  `sc_addtime` datetime DEFAULT NULL COMMENT '添加时间',
  PRIMARY KEY (`sc_id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='收藏表';

-- ----------------------------
-- Records of study_collect
-- ----------------------------

-- ----------------------------
-- Table structure for study_comment
-- ----------------------------
DROP TABLE IF EXISTS `study_comment`;
CREATE TABLE `study_comment` (
  `sc_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
  `sc_sv_id` int(11) NOT NULL DEFAULT '0' COMMENT '视频id',
  `sc_svl_id` int(11) NOT NULL DEFAULT '0' COMMENT '章节id',
  `sc_uid` int(11) NOT NULL DEFAULT '0' COMMENT '用户id',
  `sc_zan` int(11) NOT NULL DEFAULT '0' COMMENT '点赞数',
  `sc_content` text COMMENT '评论内容',
  `sc_addtime` datetime DEFAULT NULL COMMENT '添加时间',
  PRIMARY KEY (`sc_id`)
) ENGINE=InnoDB AUTO_INCREMENT=27 DEFAULT CHARSET=utf8 COMMENT='评论表';

-- ----------------------------
-- Records of study_comment
-- ----------------------------
INSERT INTO `study_comment` VALUES ('7', '1', '2', '1', '253', '感谢老师课程分享，期待你的下个课程。', '2017-04-14 21:47:15');
INSERT INTO `study_comment` VALUES ('8', '1', '2', '0', '0', 'test', '2017-04-17 17:57:28');
INSERT INTO `study_comment` VALUES ('9', '1', '2', '0', '0', 'test123', '2017-04-17 18:04:41');
INSERT INTO `study_comment` VALUES ('10', '1', '2', '0', '0', 'test456', '2017-04-17 18:06:21');
INSERT INTO `study_comment` VALUES ('11', '1', '2', '0', '0', 'test789', '2017-04-17 18:07:21');
INSERT INTO `study_comment` VALUES ('12', '1', '2', '0', '0', 'test111', '2017-04-17 18:07:48');
INSERT INTO `study_comment` VALUES ('13', '1', '2', '0', '0', 'test222', '2017-04-17 18:08:18');
INSERT INTO `study_comment` VALUES ('14', '1', '2', '0', '0', 'test333', '2017-04-17 18:08:49');
INSERT INTO `study_comment` VALUES ('15', '1', '2', '0', '0', 'test555', '2017-04-17 18:09:14');
INSERT INTO `study_comment` VALUES ('16', '1', '2', '0', '0', 'test555', '2017-04-17 18:09:18');
INSERT INTO `study_comment` VALUES ('17', '1', '2', '0', '0', 'test555', '2017-04-17 18:09:22');
INSERT INTO `study_comment` VALUES ('18', '1', '2', '0', '0', 'test666', '2017-04-17 18:09:42');
INSERT INTO `study_comment` VALUES ('19', '1', '2', '0', '0', 'test666', '2017-04-17 18:09:45');
INSERT INTO `study_comment` VALUES ('20', '1', '2', '0', '0', 'test777', '2017-04-17 18:10:22');
INSERT INTO `study_comment` VALUES ('21', '1', '2', '0', '0', '非常好', '2017-04-18 09:22:45');
INSERT INTO `study_comment` VALUES ('22', '1', '2', '0', '0', '非常好', '2017-04-18 09:22:49');
INSERT INTO `study_comment` VALUES ('23', '1', '2', '0', '0', 'test', '2017-04-18 16:55:52');
INSERT INTO `study_comment` VALUES ('24', '1', '2', '0', '0', 'test', '2017-04-18 16:55:55');
INSERT INTO `study_comment` VALUES ('25', '1', '3', '0', '0', 'test', '2017-04-18 16:56:22');
INSERT INTO `study_comment` VALUES ('26', '1', '2', '1', '0', 'test', '2017-04-25 14:37:01');
...
CREATE TABLE `study_course` (
  `sc_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
  `sc_c_id` int(11) NOT NULL DEFAULT '0' COMMENT '分类表sc_id',
  `sc_name` varchar(128) NOT NULL COMMENT '课程名称',
  `sc_sort` smallint(2) DEFAULT '0' COMMENT '排序',
  `sc_addtime` datetime DEFAULT NULL COMMENT '添加时间',
  PRIMARY KEY (`sc_id`)
...
-- ----------------------------
INSERT INTO `study_course` VALUES ('1', '1', '前端开发', '0', '2017-04-14 09:52:49');
INSERT INTO `study_course` VALUES ('2', '1', '后台开发', '0', '2017-04-14 09:53:04');
INSERT INTO `study_course` VALUES ('3', '1', 'UI设计', '0', '2017-04-14 09:53:18');
INSERT INTO `study_course` VALUES ('4', '1', '网络安全', '0', '2017-04-14 09:53:33');
INSERT INTO `study_course` VALUES ('5', '1', '信息科学', '0', '2017-04-14 09:53:45');
INSERT INTO `study_course` VALUES ('6', '2', '电子信息', '0', '2017-04-14 10:41:30');
INSERT INTO `study_course` VALUES ('7', '2', '通讯工程', '0', '2017-04-14 10:41:45');
INSERT INTO `study_course` VALUES ('8', '3', '工程管理', '0', '2017-04-14 12:13:00');
...
CREATE TABLE `study_history` (
  `sh_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
  `sh_sv_id` int(11) NOT NULL DEFAULT '0' COMMENT '视频sv_id',
  `sh_svl_id` int(11) NOT NULL DEFAULT '0' COMMENT '章节svl_id',
  `sh_uid` int(11) NOT NULL DEFAULT '0' COMMENT '用户id',
  `sh_addtime` datetime DEFAULT NULL COMMENT '添加时间',
  PRIMARY KEY (`sh_id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='观看历史表';

-- ----------------------------
-- Records of study_history
-- ----------------------------
INSERT INTO `study_history` VALUES ('6', '1', '5', '0', '2017-04-21 11:39:40');
INSERT INTO `study_history` VALUES ('7', '1', '2', '0', '2017-04-21 11:40:20');
INSERT INTO `study_history` VALUES ('8', '1', '2', '1', '2017-04-25 14:31:39');
INSERT INTO `study_history` VALUES ('9', '1', '5', '1', '2017-04-25 14:31:51');
INSERT INTO `study_history` VALUES ('10', '1', '3', '1', '2017-04-25 14:31:55');
...
CREATE TABLE `study_user` (
  ...
  `aboutme` varchar(255) DEFAULT '' COMMENT '个性签名',
  `position` varchar(128) DEFAULT '0' COMMENT '职位',
...
-- ----------------------------
INSERT INTO `study_user` VALUES ('1', 'qq_老郎', 'f1887d3f9e6ee7a32fe5e76f4ab80d63', '1', 'aa@aa.com', '18871867653', '今天天气很好', 'PHP开发工程师', '', '', '', '', '0', null, '1', '2017-04-19 16:38:16');
...
CREATE TABLE `study_video` (
  `sv_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
  `sv_cat_id` int(11) NOT NULL DEFAULT '0' COMMENT '分类id',
  `sv_co_id` int(11) NOT NULL DEFAULT '0' COMMENT '课程id',
  `sv_name` varchar(255) NOT NULL COMMENT '视频名称',
  `sv_study_num` int(11) NOT NULL DEFAULT '0' COMMENT '学习人数',
  `sv_level` smallint(3) DEFAULT '1' COMMENT '难度级别 1：初级 2：中级 3：高级',
  `sv_course_time` varchar(128) DEFAULT '0' COMMENT '课程时长',
  `sv_score` float DEFAULT '0' COMMENT '评分',
  `sv_title` varchar(255) DEFAULT NULL COMMENT '标题',
  `sv_desc` varchar(255) DEFAULT NULL COMMENT '课程简介',
  `sv_course_info` varchar(255) DEFAULT NULL COMMENT '课程须知',
  `sv_what` varchar(255) DEFAULT NULL,
  `sv_teacher_id` int(11) DEFAULT '0' COMMENT '发布讲师',
  `sv_recommend` smallint(2) DEFAULT '1' COMMENT '是否推荐 1：不推荐 2：推荐',
  `sv_hot` smallint(2) DEFAULT '1' COMMENT '是否热门 1：no 2：热门',
  `sv_click` int(11) NOT NULL DEFAULT '0' COMMENT '点击率',
  `sv_zan` int(11) DEFAULT '0' COMMENT '点赞数',
  `sv_cover` varchar(255) DEFAULT NULL COMMENT '视频封面',
  `sv_addtime` datetime DEFAULT NULL COMMENT '添加时间',
  PRIMARY KEY (`sv_id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='视频表';

-- ----------------------------
-- Records of study_video
-- ----------------------------
INSERT INTO `study_video` VALUES ('1', '1', '1', 'jQuery基础 (一)—样式篇', '198', '1', '2小时23分', '9.3', 'jQuery初入开启样式修炼,体验万能的jQuery样式集搭建网站布局', 'jQuery基础课程总共分为4个部分，分别是样式篇、事件篇、动画篇、DOM篇。此为第一个部分—样式篇，本课程主要介绍jQuery的基础语法，选择器以及jQuery的一些属性和样式，通过本课程的学习，我们可以用最少的代码做更多的事，让我们一起出发学习吧！', '您至少掌握HTML+CSS基础知识', '通过JavaScript学习，掌握基本语法，制作简单交互式页面', '0', '2', '2', '140', '18', null, '2017-04-14 12:03:02');
INSERT INTO `study_video` VALUES ('2', '1', '1', 'JS+CSS3实现“粽情端午”', '2577', '2', '2小时23分', '8.5', '用JS和CSS3技术实现3D效果粽子特效动画，掌握动画制作过程', '本课程带领大家使用JS和CSS3技术实现粽子动画的效果，课程分为“分析动画特效”和“开发”两个部分，分析动画部分使用“关键时间点逆向分析”的方法带领大家把动画制作过程揭秘出来，“开发”部分，首先对动画效果进行深入剖析、然后再进行动画的一步一步分步制作。', null, null, '0', '2', '2', '9', '0', null, '2017-04-14 12:03:07');
INSERT INTO `study_video` VALUES ('3', '1', '1', '倒计时效果', '56625', '3', '2小时23分', '9.8', '电商网站限时抢购倒计时效果计算思路和方法，前端开发必备技术', '现今团购网、电商网、门户网等，常使用时间记录重要的时刻，如时间显示、倒计时差、限时抢购等，本课程分析不同倒计时效果的计算思路及方法，掌握日期对象Date，获取时间的方法,计算时差的方法，实现不同的倒时计效果。', null, null, '0', '2', '2', '0', '0', null, null);
INSERT INTO `study_video` VALUES ('4', '1', '1', 'JS实现人机大战之五子棋', '588', '3', '2小时23分', '7.2', '利用js及canvas绘图知识，实现程序界面编写和交互逻辑处理', '本案例是一个带AI的五子棋人机大战程序，课程分为两篇，本篇UI篇主要介绍案例界面的编写以及交互逻辑的处理，主要涉及js及canvas绘图知识。', null, null, '0', '2', '2', '0', '0', null, null);
INSERT INTO `study_video` VALUES ('5', '1', '1', '带你入门Vue2.0及案例开发', '500', '3', '2小时23分', '9.6', '从入门到实战全面讲解Vue2.0，用Vue2.0开发一个数字产品电商平台', 'Vue.js入门基础》讲师倾情推出的实战课程，使用Vue2.0版本，带你快速入门Vue2.0，完成从入门到实战的完美过渡，为之后使用Vue2.0做更高级的开发打下坚实', null, null, '0', '2', '2', '0', '0', null, null);

-- ----------------------------
-- Table structure for study_video_list
-- ----------------------------
DROP TABLE IF EXISTS `study_video_list`;
CREATE TABLE `study_video_list` (
  `svl_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
  `svl_sv_id` int(11) DEFAULT NULL COMMENT '视频id',
  `svl_pid` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '父id',
  `svl_cat_id` int(11) NOT NULL DEFAULT '0' COMMENT '分类id',
  `svl_co_id` int(11) NOT NULL DEFAULT '0' COMMENT '课程id',
  `svl_chapter_no` varchar(64) NOT NULL COMMENT '章节编号',
  `svl_name` varchar(255) NOT NULL COMMENT '章节名称',
  `svl_title` varchar(255) DEFAULT NULL COMMENT '章节描述',
  `svl_click` int(11) NOT NULL DEFAULT '0' COMMENT '点击率',
  `svl_video_url` varchar(255) DEFAULT NULL COMMENT '视频链接',
  `svl_sort` smallint(2) DEFAULT '1' COMMENT '排序',
  `svl_addtime` datetime DEFAULT NULL COMMENT '添加时间',
  PRIMARY KEY (`svl_id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='视频表';

-- ----------------------------
-- Records of study_video_list
-- ----------------------------
INSERT INTO `study_video_list` VALUES ('1', '1', '0', '1', '1', '第1章', 'jQuery 实现Ajax应用', '本章节主要讲解如何在HTML文件中添加JavaScript代码，引用独立JS文件，学习必要的基础语法，为下一章学习打下基础。', '0', null, '1', null);
INSERT INTO `study_video_list` VALUES ('2', '1', '1', '1', '1', '1-1', '使用load()方法异步请求数据', null, '0', 'http://www.fmooc.com/upload/video/testvideo.mp4', '1', null);
INSERT INTO `study_video_list` VALUES ('3', '1', '1', '1', '1', '1-2', '使用getJSON()方法异步加载JSON格式数据', null, '0', null, '1', null);
INSERT INTO `study_video_list` VALUES ('4', '1', '0', '1', '1', '第2章', 'jQuery 常用插件', '本章节先通过示例与插件相结合的方式，详细介绍了目前最为流行的各类插件的使用方法和技巧，包括表单插件、图片插件等；然后,介绍了如何自定义编写对象和类级别插件的过程。', '0', '', '1', null);
INSERT INTO `study_video_list` VALUES ('5', '1', '4', '1', '1', '2-1', '表单验证插件——validate', null, '0', 'http://www.fmooc.com/upload/video/sellertest.mp4', '1', null);
INSERT INTO `study_video_list` VALUES ('6', '1', '4', '1', '1', '2-2', '表单插件——form ', null, '0', null, '1', null);
INSERT INTO `study_video_list` VALUES ('7', '1', '4', '1', '1', '2-3', '图片灯箱插件——lightBox', null, '0', null, '1', null);
...
INSERT INTO `system_config` VALUES ('173', 'app_name', '后台管理');
...
CREATE TABLE `system_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8 COMMENT='系统操作日志表';

-- ----------------------------
-- Records of system_log
-- ----------------------------
INSERT INTO `system_log` VALUES ('7', '127.0.0.1', 'admin/login/index', 'admin', '登录系统', '用户登录系统成功!', '2017-03-30 09:54:39');
INSERT INTO `system_log` VALUES ('8', '127.0.0.1', 'admin/login/index', 'admin', '登录系统', '用户登录系统成功!', '2017-03-30 11:28:03');
INSERT INTO `system_log` VALUES ('9', '127.0.0.1', 'admin/login/index', 'admin', '登录系统', '用户登录系统成功!', '2017-03-30 11:28:38');
INSERT INTO `system_log` VALUES ('10', '127.0.0.1', 'admin/login/index', 'admin', '登录系统', '用户登录系统成功!', '2017-03-30 11:28:57');
INSERT INTO `system_log` VALUES ('11', '127.0.0.1', 'admin/login/out', 'admin', '退出系统', '用户退出系统成功!', '2017-03-30 16:22:27');
INSERT INTO `system_log` VALUES ('12', '127.0.0.1', 'admin/login/index', 'test123', '登录系统', '用户登录系统成功!', '2017-03-30 16:22:36');
INSERT INTO `system_log` VALUES ('13', '127.0.0.1', 'admin/login/index', 'admin', '登录系统', '用户登录系统成功!', '2017-04-13 13:51:52');
INSERT INTO `system_log` VALUES ('14', '127.0.0.1', 'admin/login/index', 'admin', '登录系统', '用户登录系统成功!', '2017-04-13 14:34:50');
INSERT INTO `system_log` VALUES ('15', '127.0.0.1', 'admin/login/index', 'admin', '登录系统', '用户登录系统成功!', '2017-04-13 17:53:41');
INSERT INTO `system_log` VALUES ('16', '127.0.0.1', 'admin/login/index', 'admin', '登录系统', '用户登录系统成功!', '2017-04-17 18:31:01');
...
INSERT INTO `system_menu` VALUES ('22', '20', '节点管理', '', 'fa fa-ellipsis-v', 'admin/nodes/index', '', '_self', '30', '1', '0', '2015-11-16 19:16:16');
...
-- ----------------------------
INSERT INTO `system_user` VALUES ('10000', 'admin', '21232f297a57a5a743894a0e4a801fc3', '22222222', 'zoujingli@cuci.ccc', '13617343801', '4444445', '3682', '2017-04-17 18:31:01', '1', '98,102,103,104', '0', null, '2015-11-13 15:14:22');
INSERT INTO `system_user` VALUES ('10010', 'test', '', null, '', '13687227657', '', '0', null, '1', '71,72', '0', null, '2017-03-15 14:57:22');
INSERT INTO `system_user` VALUES ('10011', 'test1', '', null, '', '', '', '0', null, '1', null, '0', null, '2017-03-15 22:42:38');
INSERT INTO `system_user` VALUES ('10012', '你好', '', null, 'eqomnc@q.com', '13738152615', '', '0', null, '1', '72', '0', null, '2017-03-16 10:19:34');
INSERT INTO `system_user` VALUES ('10013', '个636', '', null, '841115691@qq.com', '18875948598', '浮动个', '0', null, '1', '72,73,74,75,77', '0', null, '2017-03-16 11:46:00');
INSERT INTO `system_user` VALUES ('10014', '31212312123', '', null, '', '', '', '0', null, '1', null, '0', null, '2017-03-16 14:42:09');
INSERT INTO `system_user` VALUES ('10015', 'uzi', '4297f44b13955235245b2497399d7a93', null, '', '', '', '0', null, '1', '79', '0', null, '2017-03-16 16:04:08');
INSERT INTO `system_user` VALUES ('10016', 'uzii', '4297f44b13955235245b2497399d7a93', null, '', '', '', '1', '2017-03-16 16:10:38', '1', '79', '0', null, '2017-03-16 16:09:52');
INSERT INTO `system_user` VALUES ('10017', 'aaa', 'e10adc3949ba59abbe56e057f20f883e', null, '', '18866666666', '111', '0', null, '1', '78', '0', null, '2017-03-17 11:14:30');
INSERT INTO `system_user` VALUES ('10018', 'anyon', '21232f297a57a5a743894a0e4a801fc3', null, '', '', '', '8', '2017-03-17 15:33:20', '1', '81', '0', null, '2017-03-17 14:20:14');
INSERT INTO `system_user` VALUES ('10019', 'flsdfkj', '', null, '', '', '', '0', null, '0', '84', '0', null, '2017-03-17 17:46:12');
INSERT INTO `system_user` VALUES ('10020', '11', '', null, '111@qq.com', '15021975678', '', '0', null, '1', null, '0', null, '2017-03-18 22:22:28');
INSERT INTO `system_user` VALUES ('10021', 'test001', '', null, '', '13712312312', '', '0', null, '1', null, '0', null, '2017-03-20 11:16:35');
INSERT INTO `system_user` VALUES ('10022', 'tt', '', null, '3333@qq.com', '15021975913', 'dfdf', '0', null, '0', null, '0', null, '2017-03-20 15:36:12');
INSERT INTO `system_user` VALUES ('10023', '112', '', null, '3333@qq.com', '15021975914', 'dfdf', '0', null, '1', null, '0', null, '2017-03-20 17:20:23');
INSERT INTO `system_user` VALUES ('10024', '1122', '', null, '3333@qq.com', '15021975913', '11', '0', null, '1', null, '0', null, '2017-03-20 17:21:24');
INSERT INTO `system_user` VALUES ('10025', '33', '', null, '3333@qq.com', '15021975913', '333', '0', null, '1', null, '0', null, '2017-03-20 17:21:37');
INSERT INTO `system_user` VALUES ('10026', 'test1112313', '', null, '', '18987676656', '特讨厌', '0', null, '1', '86,89', '0', null, '2017-03-21 09:44:05');
INSERT INTO `system_user` VALUES ('10027', 'aaasdfsdf', '', null, '', '', 'sf', '0', null, '1', '84', '0', null, '2017-03-21 10:36:52');
INSERT INTO `system_user` VALUES ('10028', '20256811', 'e10adc3949ba59abbe56e057f20f883e', null, '', '18829025582', '', '1', '2017-03-21 14:33:29', '1', '94,95', '0', null, '2017-03-21 14:32:41');
INSERT INTO `system_user` VALUES ('10029', '351402401', 'e10adc3949ba59abbe56e057f20f883e', null, '', '', '351402401', '1', '2017-03-21 17:16:46', '1', '94', '0', null, '2017-03-21 17:15:13');
INSERT INTO `system_user` VALUES ('10030', '测试', '', null, '', '', '', '0', null, '1', null, '0', null, '2017-03-21 17:23:02');
INSERT INTO `system_user` VALUES ('10031', '1312', '', null, '1123@ad.adf', '15423232345', '123123', '0', null, '1', '93', '0', null, '2017-03-22 10:12:12');
INSERT INTO `system_user` VALUES ('10032', '111', '', null, '', '13899665566', '', '0', null, '1', null, '0', null, '2017-03-22 12:58:23');
INSERT INTO `system_user` VALUES ('10033', 'weiwie', '', null, '1234567@qq.com', '18308463002', 'wu ', '0', null, '1', '94,95', '0', null, '2017-03-23 14:23:19');
INSERT INTO `system_user` VALUES ('10034', '123123', '', null, '123@qq.com', '14012311231', 'asd', '0', null, '1', '94,95', '0', null, '2017-03-23 15:19:56');
INSERT INTO `system_user` VALUES ('10035', 'gzx', '', null, 'gxx@163.com', '13826429302', 'ds', '0', null, '0', '95,96,97', '0', null, '2017-03-23 16:37:56');
INSERT INTO `system_user` VALUES ('10036', 'gxy', '', null, 'fs@ss.com', '13826429303', '', '0', null, '0', '95,96,97', '0', null, '2017-03-23 16:43:42');
INSERT INTO `system_user` VALUES ('10037', 'dd', '', null, 'dds@ss.com', '13826429303', '', '0', null, '1', '94,95', '0', null, '2017-03-23 16:55:29');
INSERT INTO `system_user` VALUES ('10038', 'fsee', '', null, '556@dd.com', '13719205474', '', '0', null, '1', '94', '0', null, '2017-03-23 17:02:13');
INSERT INTO `system_user` VALUES ('10039', 'test123', 'e10adc3949ba59abbe56e057f20f883e', null, '', '', '', '3', '2017-03-30 16:22:36', '1', '98', '0', null, '2017-03-24 11:44:53');
INSERT INTO `system_user` VALUES ('10040', 'sdf', '', null, '1732702632@qq.com', '18336967516', 'adfsf ', '0', null, '1', '98', '0', null, '2017-03-24 15:44:56');

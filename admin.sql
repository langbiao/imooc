...
CREATE TABLE `study_collect` (
  `sc_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
  `sc_sv_id` int(11) NOT NULL DEFAULT '0' COMMENT '视频sc_id',
  `sc_uid` varchar(128) NOT NULL COMMENT '用户id',
  `sc_addtime` datetime DEFAULT NULL COMMENT '添加时间',
  PRIMARY KEY (`sc_id`)
...
-- ----------------------------
INSERT INTO `study_video` VALUES ('1', '1', '1', 'jQuery基础 (一)—样式篇', '67', '1', '2小时23分', '9.3', 'jQuery初入开启样式修炼,体验万能的jQuery样式集搭建网站布局', 'jQuery基础课程总共分为4个部分，分别是样式篇、事件篇、动画篇、DOM篇。此为第一个部分—样式篇，本课程主要介绍jQuery的基础语法，选择器以及jQuery的一些属性和样式，通过本课程的学习，我们可以用最少的代码做更多的事，让我们一起出发学习吧！', '您至少掌握HTML+CSS基础知识', '通过JavaScript学习，掌握基本语法，制作简单交互式页面', '0', '2', '2', '9', '7', null, '2017-04-14 12:03:02');
INSERT INTO `study_video` VALUES ('2', '1', '1', 'JS+CSS3实现“粽情端午”', '2568', '2', '2小时23分', '8.5', '用JS和CSS3技术实现3D效果粽子特效动画，掌握动画制作过程', '本课程带领大家使用JS和CSS3技术实现粽子动画的效果，课程分为“分析动画特效”和“开发”两个部分，分析动画部分使用“关键时间点逆向分析”的方法带领大家把动画制作过程揭秘出来，“开发”部分，首先对动画效果进行深入剖析、然后再进行动画的一步一步分步制作。', null, null, '0', '2', '2', '0', '0', null, '2017-04-14 12:03:07');
...
INSERT INTO `study_video_list` VALUES ('2', '1', '1', '1', '1', '1-1 使用load()方法异步请求数据', null, '0', null, '1', null);
INSERT INTO `study_video_list` VALUES ('3', '1', '1', '1', '1', '1-2 使用getJSON()方法异步加载JSON格式数据', null, '0', null, '1', null);
INSERT INTO `study_video_list` VALUES ('4', '1', '0', '1', '1', '第2章 jQuery 常用插件', '本章节先通过示例与插件相结合的方式，详细介绍了目前最为流行的各类插件的使用方法和技巧，包括表单插件、图片插件等；然后,介绍了如何自定义编写对象和类级别插件的过程。', '0', null, '1', null);
INSERT INTO `study_video_list` VALUES ('5', '1', '4', '1', '1', '2-1 表单验证插件——validate', null, '0', null, '1', null);
...
-- ----------------------------
INSERT INTO `system_user` VALUES ('10000', 'admin', '21232f297a57a5a743894a0e4a801fc3', '22222222', 'zoujingli@cuci.ccc', '13617343801', '4444445', '3681', '2017-04-13 17:53:41', '1', '98,102,103,104', '0', null, '2015-11-13 15:14:22');
